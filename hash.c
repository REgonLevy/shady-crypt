void hash(char *pw) {
    ...
    long long r[468], q[280];
    long long base = 1 << 29;
    long long mask = base - 1;
    long long c;
    unsigned int state[4827];
    unsigned int carry, cng, xs, tt, xx, vv, ww, gg;
    unsigned int password[100];
    unsigned int ss1, ss2, ast = 0, strr = 0;
    int kk = 16384;
    int sample[16384], table[16384];
