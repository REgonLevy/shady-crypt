void hash(char *pw) {
    ...
    // 6760 bit modulus for BBS. M = p * q, where p and q are both randomly generated 3380 bit "safe" primes, with gcd ((p-3)/2, (q-3)/2) = 2. (see Klein, Stream Ciphers, Springer (2013) pp. 250-66). Mp and mpp are subsets of m, multiplied by 2 and 4, respectively, to be used in short products. Hardcoded for efficiency in wasm.
